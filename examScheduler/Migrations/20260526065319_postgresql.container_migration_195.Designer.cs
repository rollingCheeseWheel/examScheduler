...
namespace examScheduler.Migrations
{
    ...
    [Migration("20260526065319_postgresql.container_migration_195")]
    partial class postgresqlcontainer_migration_195
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Calendar", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("LastExtended")
            ...
            modelBuilder.Entity("Entities.ExamSlot", b =>
                {
                    ...
                    b.Property<bool>("HasBeenAutoFilled")
            ...
            modelBuilder.Entity("Entities.ScheduleGenerator", b =>
                {
                    ...
                    b.PrimitiveCollection<DateTimeOffset[]>("BlacklistedDays")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("timestamp with time zone[]");
            ...
            modelBuilder.Entity("Entities.Teacher", b =>
                {
                    ...
                    b.HasOne("Entities.TeacherProfile", "TeacherProfile")
                        .WithOne("Teacher")
                        .HasForeignKey("Entities.Teacher", "TeacherProfileId");
